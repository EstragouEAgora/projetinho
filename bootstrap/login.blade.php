                    ...
                    <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 offset-md-4 ">
                                <button type="submit" class="btn btn-primary my-2 my-sm-0" style="color: white; background-color: #3C5BBF;margin-left: 50px; border: solid;border-color: #F2AA31; border-width: 1px; width: 200px;" id ="meu-botao2"  >
                                    {{ __('Entrar') }}
                                </button>
                            </div>
            </div>
